    ...
    <section id="trainers" class="trainers">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="member-content">
                <h4>Mr.Abass Maiga</h4>
                <span>Crypto-monnaie</span>
                <p>
                  Ne a Congo Brazaville en 1999 Adama etait a l'ecole privee la                     Source, il passa ensuite au prospere kamara de lafiabougou pour                   les etudes secondaires.
                  Mr.Mariko est certifie de pirate informatique a l'an 2010 au                      Technolab Ista. 
                </p>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/formateurs/ibrahim.jpg" class="img-fluid" alt="">
              <div class="member-content">

                <h4>IBRAHIM BERTHE</h4>
               <span>Langage de programmation</span>
              <p> Ne le 06/06/2002 a bamako Mr.Berthe a fait ses études 
                    primaire a l'ecole Asmaou Bint Abibakr et continua ses                           universitaires a l'institut superieur d'informatique et de                        management (ISIM).
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="member-content">
                ...
                <h4>FOUSSEYNI FOFANA</h4>
                <span>Réseaux informatique</span>
                <p> Ne le 06/06/2002 a bamako Mr.Berthe a fait ses etudes 
                primaire a l'ecole Asmaou Bint Abibakr et continua ses                           universitaires a l'institut superieur d'informatique et de                       management (ISIM).                
                </p>
