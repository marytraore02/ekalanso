...
<head>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php"><img src="assets/img/logo/logo3.jpg" class="img-fluid" alt=""></a></h1>
      ...
      <a href="registre.php" class="get-started-btn">Créer votre compte</a>
    </div>
  </header><!-- End Header -->
  ...
  <main id="main">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h2>Les Meilleurs Etablissement</h2>
        <p>Nous vous proposons des meilleurs universites nationnale et internationnale</p>
      </div>
    </div><!-- End Breadcrumbs -->
        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                 <img src="assets/img/portfolio/asmaou.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="portfolio-description">
              ...
              <p>Le complexe Asmaou Bint Abibakr est un etablissemet prive confessionnel situé a Daoudabougou  qui a pour mission, la formation scolaire Franco-Arabe aux eleves de 3 a 5 ans pour le jardin, de 6 a 14 ans pour le fondamental et de 15 a 17 ans pour le lycee.
                  Les conditions d'admission sont consignees dans les tableaux ci-dessous :
   
                   <ul>
                       <h3>Scolarité</h3>
                <li><strong>Jardin : 85000 fcfa</strong></li>
                <li><strong>1 Cycle : 95000 fcfa</strong></li>
                <li><strong>2 C ycle: 137000</strong></li>
                <li><strong>Lycee : 185000</strong></li>
          ...
          <div class="portfolio-info">
              <h3><strong>Les pieces a fournir</strong>  </h3>
              <ul>
                  <li><strong> => 2 photos d'identité de l'enfant ou de l'élève.</strong></li>
                  <li><strong>=> 1 extrait d'acte de naissance.</strong></li>
                  <li><strong>=> 1 photocopie de la carte d'identité du père/de la mère ou du tuteur.</strong></li>
                  <li><strong>=> 1 certificat de transfert pour le cas de transfert.</strong></li>
              </ul>
            </div>
        
        <div class="portfolio-info">
              Pour tout rensignement complementaire contactez les numeros suivants :<br>
            <strong>Promotrice : 76 47 08 55</strong><br>
              <strong>Directeur generale : 74 47 27 10</strong><br>
              <strong>Secretaire generale : 51 60 56 51 </strong>
            </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <!--<h3>E-kalanso</h3>-->
            <h6 class="logo me-auto"><a href="index.php"><img src="assets/img/logo/logo3.jpg" class="img-fluid" alt=""></a></h6>
            <p> <br>
