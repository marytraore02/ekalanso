  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div data-aos="fade-up">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4917.647400007264!2d-7.980467187989819!3d12.596351732514888!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xe51cde06fc7fe85%3A0x9d91660327224789!2zMTLCsDM1JzQ2LjgiTiA3wrA1OCc0OS4yIlc!5e0!3m2!1sfr!2sml!4v1637280473859!5m2!1sfr!2sml" width="1000" height="700" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            ...
            <div class="info">
              <div class="address">
               <i class="bi bi-geo-alt"></i>
                <h4>Localite:</h4>
                <p>Daoudabougou; Rue:303; Porte:208 <br>
              BAMAKO/MALI</p>
              </div>
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>ibrahimberthe239@gmail.com</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="my-3">
                ...
                <div class="sent-message">votre message est envoye.Nous vous remercions</div>
              </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p> <br>
               Daoudabougou; Rue:303; Porte:208 <br>
              BAMAKO/MALI<br><br>
              <strong>Telephone:</strong> +223 82 86 64 06<br>
              <strong>Email:</strong>emalischool223@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="events.php">Evenement</a></li>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>eMaliSchool</span></strong>. Tout droits reserves
          Produit par<a href="https://bootstrapmade.com/">Berthech Corporation</a>
        </div>
      </div>
