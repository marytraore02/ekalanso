      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <h3>Introduction a la Crypto-monnaie</h3>
            <p><strong>La crypto-monnaie devient aujourd'hui une monnaie dominante sur le web.<br>
            Vous trouverez dans cette cour une introduction sur la crypto-monnaie, son historique, sa évolution et bien d'autre chose<br>
                Cette formation sera présenté par Mr.Abass Maiga.</strong>
              </p>
          </div>
          <div class="col-lg-4">
