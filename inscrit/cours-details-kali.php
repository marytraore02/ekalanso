      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <h3>Introduction au systeme d'exploitation linux</h3>
            <p><strong>Il existe plusieurs systeme d'expolitation, dont certaienes sont open source(libre), et d'autre sont des systemes proprietaires .<br>
                Cette serie de formation est sur le systeme Linux notament la distrubition Debian qui est Kali Linux<br>
                Ce cour a ete redige par Mr.Fode Kamory Keita expert en Architecture et systeme d'exploitation</strong>
              </p>
          </div>
          <div class="col-lg-4">
