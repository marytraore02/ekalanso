      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <p><strong>Ce cour est dedier aux etudiants en informatique  pour mieux comprendre les langage de developpemnt des sites web.<br>
                Ce cour est juste une introduction au JavaScript, l'histoire et la date de creation de cette langage, mais aussi le fonctionnement du script.<br>
