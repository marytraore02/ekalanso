      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <p><strong>L'intelligence Artificielle(ia) devient une concurence sur les marchés internationale.<br>
              Les GAFAM sont les meilleurs investisseurs dans cette domaine.<br>
                Ce cour a été présenté par Mr.Ibrahim Konare ingénieur d'état en developpement</strong>
              </p>
          </div>
          <div class="col-lg-4">
