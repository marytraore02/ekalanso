      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <p><strong>Les servers jouent un rôle très important dans le système informatique.<br>
                 Ce cour est une initiation au server notament le windows server, une introduction génerale sur le server, les différents sortes de servers.<br>
                Ce cour sera represénté par Dr.Boukaye Boubacar Traore ingénieur d'etat en base de donées.</strong>
              </p>
          </div>
          <div class="col-lg-4">
            ...
            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Formateur</h5>
              <p><a href="#">B.Boubacar Traore</a></p>
            </div>
