  ...
  <main id="main">
    ...
    <section id="course-details" class="course-details">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            <img src="assets/img/cour/reseaux1.jpg" class="img-fluid" alt="">
            <h3>Introduction aux Réseaux infoematique</h3>
            <p><strong>L'apparution de réseaux informatique est devenu aujourd'hui une phénomène très importante dans le monde actuelle.Grâce à l'internet le monde entier est interconnecté de l'est à l'ouest, du sud au nord.<br>
                Cette serie de formation une introduction sur le Réseaux informatique, l'historique et le fonctionnement du réseaux.<br>
                Ce cour a été redige par Mr.Fode Kamory Keita expert en Architecture et systeme d'exploitation.</strong>
              </p>
          </div>
          <div class="col-lg-4">
            ...
            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Formateur</h5>
              <p><a href="#">Fode Kamory Keita</a></p>
            </div>
