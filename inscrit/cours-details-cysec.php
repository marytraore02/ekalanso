      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <h3>Introduction à la sécurité informatique</h3>
            <p><strong>Le piratage de système d'information, la propagation des virus sur le web, le vol d'information confidentienl, deviennent de plus en plus dominante dans le domaine informatique.<br>
               Ce cour est une formation sur comment se protéger des pirates malveillants, et des méthodes appliquées pour la sécurité<br>
                Cette formation sera rédigée par Mr.Mohamed Traore ingénieur en cybersécurité</strong>
              </p>
          </div>
          <div class="col-lg-4">
