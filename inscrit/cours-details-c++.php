  ...
  <main id="main">
    ...
    <section id="course-details" class="course-details">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            <img src="assets/img/cour/codepc.jpg" class="img-fluid" alt="">
            <h3>Introduction au Langage de programmation</h3>
            <p><strong>Le langage utilisé par la machine est le langage binaire. Il existe plusieurs types de langage de programmation pour le developpement des logiciels, des programmes. <br>
                          Parmis ces langange on trouve des langages de bas niveau(c, c++, assembleur), et des langages de haut niveau(Python, turbo pascal, perl).<br>
                Cette est sur le langage C++, l'une des langages les plus utilisés par les développeurs, à cause de sa puissance de traitement des informations, mais aussi avec l'allocation de la memoire.<br>
                   Ce cour a été redige par Nene Sylla experte en developpement et programmation informatique. </strong>
              </p>
          </div>
          <div class="col-lg-4">
            ...
            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Durée de validite</h5>
              <p>1 mois</p>
            </div>

            <div class="course-info d-flex justify-content-between align-items-center">
              <h5>Niveau du cour</h5>
              <p>Debutant</p>
            </div>
