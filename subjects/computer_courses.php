...
<head>
	...
	<title>Les Cours d'Informatique</title>
...
<!-- NAVIGATION -->
	<header>
		<div class="nav" id="nav">
			<div id="learned-logo">
			<a href="../index.php"><img src="../assets/images/icon/Sans titre-1.jpg" style="width: 120px;"></a></div>
			<div class="switch-tab" id="switch-tab" onclick="switchTAB()"><img src="../assets/images/icon/menu.png"></div>
			<ul id="list-switch">
				<li><a href="formation.php"><img src="../assets/images/courses/d1.png" class="icon">Formation</a></li>
				...
				<li><a href="#projects"><img src="../assets/images/courses/projects.png" class="icon">Projets</a></li>
			</ul>
			<div class="search" id="search-switch">
				<input type="search" placeholder="Search" class="srch"><button id="srchbtn"><img src="../assets/images/icon/search.png"></button>
			</div>
		</div>
	</header>
...
<!-- Some KeyWords related to Topic -->
	<div class="course">
		<div class="cbox">
		<div class="det"><a href="#java">Langage Java</a></div>
		<div class="det"><a href="https://developer.android.com/">Développment Android </a></div>
		...
		<div class="det"><a href="https://www.geeksforgeeks.org/introduction-of-compiler-design/">Design</a></div>
		<div class="det"><a href="https://www.coursera.org/specializations/game-design-and-development">Jeux Vidéos</a></div>
		<div class="det"><a href="#algo">Algorithmes</a></div>
		</div>
		<div class="cbox">
		<div class="det"><a href="#python">Langage Python</a></div>
		...
		<div class="cbox">
		<div class="det"><a href="#html_css">HTML et CSS</a></div>
		...
		<div class="det"><a href="https://uxplanet.org/what-is-ui-vs-ux-design-and-the-difference-d9113f6612de?gi=6d9d13f4cc95">UI Design</a></div>
		<div class="det"><a href="https://www.adobe.com/in/products/xd.php">Adobe XD</a></div>
		<div class="det"><a href="https://www.sciencedirect.com/topics/computer-science/hardware-design">Maintenance</a></div>
...
<!-- Courses Available -->
	<div class="inbt">
		Enrechir votre CV avec nos programmes informatiques
	</div>
	...
	<center>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="../assets/images/courses/java-course.jpg"></div>
				<a href="#java"><div class="spart">2 Cours <img src="../assets/images/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../assets/images/courses/python-course.png"></div>
				<a href="#python"><div class="spart">5 Cours <img src="../assets/images/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../assets/images/courses/c-course.jpg"></div>
				<a href="#c++"><div class="spart">3 Cours <img src="../assets/images/icon/dropdown.png"></div></a>
			</div>
		</div>
		<div class="ccardbox">
			<div class="dcard">
				<div class="fpart"><img src="../assets/images/courses/web-course.jpg"></div>
				<a href="#html_css"><div class="spart">6 Cours <img src="../assets/images/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../assets/images/courses/data-course.jpg"></div>
				<a href="#data"><div class="spart">2 Cours <img src="../assets/images/icon/dropdown.png"></div></a>
			</div>
			<div class="dcard">
				<div class="fpart"><img src="../assets/images/courses/algo-course.jpg"></div>
				<a href="#algo"><div class="spart">1 Cours <img src="../assets/images/icon/dropdown.png"></div></a>
			</div>
		</div>
	</center>
	</div>
...
<!-- Videos on JAVA Lectures -->
	<div class="title2" id="java">
		<span>Commencez à Programmer avec Java</span>
		<div class="shortdesc2">
			<p>prariquez pour être un bon programmeur Java</p>
		</div>
	</div>
	...
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2">
					<img src="../assets/images/courses/java-course.jpg">
	...
	<br><br>
	<div class="click-me">
		<a href="https://www.youtube.com/watch?v=IsLyduxZ9sc&list=PLX9Zi6XTqOKQ7TdRz0QynGIKuMV9Q2H8E" target="_blank">Voir le playlist</a>
	</div>

<!-- Videos on C++ Lectures -->

	<div class="title2" id="c++">
		<span>Commencez à Programmer avec C++</span>
		<div class="shortdesc2">
			<p>prariquez pour être un bon programmeur C++</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../assets/images/courses/c-course.jpg">
...
<br><br>
	<div class="click-me">
		<a href="https://www.youtube.com/watch?v=Iuo9PpGE04Y&feature=youtu.be" target="_blank">Voir le playlist</a>
	</div>

<!-- Videos on PYTHON Lectures -->

	<div class="title2" id="python">
		<span>Commencez à Programmer avec Python</span>
		<div class="shortdesc2">
			<p>prariquez pour être un bon programmeur Python</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../assets/images/courses/python-course.png">
...
<br><br>
	<div class="click-me">
		<a href="https://youtu.be/QXeEoD0pB3E" target="_blank">Voir le playlist</a>
	</div>
<!-- Videos on DATA STRUCTURES Lectures -->
	...
	<div class="title2" id="data">
		...
		<div class="shortdesc2">
			<p>Comprendre les structures de données ...</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../assets/images/courses/data-course.jpg">
...
<br><br>
	<div class="click-me">
		<a href="https://www.youtube.com/watch?v=Db9ZYbJONHc" target="_blank">Voir le playlist</a>
	</div>
...
<!-- Videos on ALGORITHM Lectures -->
	...
	<div class="title2" id="algo">
		...
		<div class="shortdesc2">
			<p>Comprendre le concepte d'algorithme...</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../assets/images/courses/algo-course.jpg">
...
<br><br>
	<div class="click-me">
		<a href="https://www.youtube.com/watch?v=0IAPZzGSbME" target="_blank">Voir le playlist</a>
	</div>

<!-- Videos on HTML and CSS Lectures -->

	<div class="title2" id="html_css">
		<span>Commencez à Programmer avec HTML et CSS</span>
		<div class="shortdesc2">
			<p>Montrez votre créativité</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../assets/images/courses/web-course.jpg">
...
<br><br>
	<div class="click-me">
		<a href="https://www.youtube.com/watch?v=TKYsuU86-DQ" target="_blank">Voir le playlist</a>
	</div>
<!-- Videos on JAVASCRIPT Lectures -->

	<div class="title2" id="javascript">
		<span>Commencez à Programmer avec JavaScript</span>
		<div class="shortdesc2">
			<p>Commencez votre projet</p>
		</div>
	</div>
	<center>
		<div class="ccardbox2">
			<div class="dcard2"><span class="tag" >1/8</span>
				<div class="fpart2"><img src="../assets/images/courses/javascript-course.jpg">
...
<br><br>
	<div class="click-me">
		<a href="https://www.youtube.com/watch?v=uDwSnnhl1Ng" target="_blank">Voir le playlist</a>
	</div>
...
<!-- PROJECTS -->
	...
	<div class="project-panel">
		<div class="project-card">
			<img src="../assets/images/projects/p1.jpg">
			<div class="info">
		...
		<div class="project-card">
			<img src="../assets/images/projects/p2.jpg">
			<div class="info">
		...
		<div class="project-card">
			<img src="../assets/images/projects/p3.jpg">
			<div class="info">
		...
		<div class="project-card">
			<img src="../assets/images/projects/p4.jpg">
			<div class="info">
		...
		<div class="project-card">
			<img src="../assets/images/projects/p5.jpg">
			<div class="info">
